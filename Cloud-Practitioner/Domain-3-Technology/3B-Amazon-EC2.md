...
### Amazon Machine Image (AMI)
   ...
   * **There are 3 types of AMIs:**
       ...
       * **Custom AMIs:**
         * AMIs you've built yourself. Best practice for Custom AMIs is to build them and install all the software, data, applications, and configurations you want before you create the snapshot. This way, if you need to load it into a different EC2 instance, you have the entire VM snapshotted and can easily upload it in one fell swoop (versus having to manually install the software and apps and manually configuring the instance each time you want to boot up a new one).
